DESCRIPTION = "Definitions for the prr-user recipe, which creates an everyday user account on the system."
LICENSE = "MIT"
...
OTHER_GROUPS = "sudo dialout audio video pixelatedrailroad plugdev users input netdev gpio i2c spi"

PASSWD_SALT = "${@bb.utils.contains('IMAGE_FEATURES', 'release', 'Diam0nd188#', 'pixeleatedrail', d)}"
PASSWD_VALUE = "${@bb.utils.contains('IMAGE_FEATURES', 'release', 'di@mond188#', 'prrtest', d)}"
